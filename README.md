...
[multisig-coordinator-btc](https://github.com/satsforge/multisig-coordinator-btc) y
[inheritance-planner-btc](https://github.com/satsforge/inheritance-planner-btc).
...
```
index.html              landing page (linkea a las seis herramientas)
paper-wallet-btc/
...
`multisig-coordinator-btc` e `inheritance-planner-btc` (mismo nivel, en el
